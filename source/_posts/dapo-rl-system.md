...
> 本文是对论文《DAPO: An Open-Source LLM Reinforcement Learning System at Scale》的阅读笔记与解读。原文见 arXiv:2503.14476（<https://arxiv.org/abs/2503.14476>）。文中观点与数据均以原论文为准，本文仅做梳理与延伸。

## TL;DR

- **是什么**：DAPO（Decoupled Clip and Dynamic Sampling Policy Optimization）是一套面向大语言模型推理能力训练的、完全开源的大规模强化学习系统，由原论文作者团队提出。
