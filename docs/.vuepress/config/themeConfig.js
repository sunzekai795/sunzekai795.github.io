...
module.exports = {
  ...
  sidebar: {
    ...
    '/00.目录页/': [
      {
        title: '目录页',  // 侧边栏的标题
        collapsable: false,  // 设置为不可折叠
        children: [
          // 确保路径与文件结构一致，引用的文件路径都存在
          '01.one.md',   // 假设文件 docs/00.目录页/01.first.md 存在
          '02.two.md',  // 假设文件 docs/00.目录页/02.second.md 存在
          '03.three.md',   // 假设文件 docs/00.目录页/03.third.md 存在
          '04.four.md'   // 假设文件 docs/00.目录页/04.fourth.md 存在
        ]
      }
    ],
  },
  ...
  author: {
    ...
    name: 'sunzekai', // 必需
    link: 'https://github.com/sunzekai795', // 可选的
  },
  social: {
    // 社交图标，显示于博主信息栏和页脚栏
    ...
    icons: [
      {
        ...
        title: 'GitHub',
        link: 'https://github.com/sunzekai795',
      },
      {
        iconClass: 'icon-youjian',
        title: '发邮件',
        link: 'mailto:sunzekai795@163.com',
      },
      {
        iconClass: 'icon-gitee',
        title: 'Gitee',
        link: 'https://gitee.com/sunzekai795',
      },
    ],
  },
  footer: {
